...
if __name__ == "__main__":
    ...
    app = FastAPI()
    chat_server = ChatServer(host="0.0.0.0", port=8765)
    app.add_event_handler("startup", chat_server.start)
    app.add_event_handler("shutdown", chat_server.start)
    uvicorn.run(app, host=chat_server.host, port=chat_server.port, log_level="info")
